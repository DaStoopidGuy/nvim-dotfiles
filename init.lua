...
-- vim.keymap.set('n', '<leader>t', "<CMD>TodoTelescope<CR>", { desc = "Todo comments" })
...
cmp.setup({
    ...
    mapping = cmp.mapping.preset.insert {
        ...
        -- moving in snippet expansion
        -- <c-l> will move you to the right
